...
class CharacterController extends Controller {
    ...
    */
    ...
    public function postEditCharacterProfile(Request $request, CharacterManager $service, $slug) {
        ...
        if ($service->updateCharacterProfile($request->only(['name', 'nickname', 'custom_values_group', 'custom_values_name', 'custom_values_data', 'link', 'text', 'is_gift_art_allowed', 'is_gift_writing_allowed', 'is_trading', 'alert_user', 'herd', 'height']), $this->character, Auth::user(), !$isOwner)) {
